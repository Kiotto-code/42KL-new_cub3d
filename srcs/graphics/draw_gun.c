...
/*   Updated: 2024/04/01 00:29:43 by etlaw            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	data->gun[0] = "./textures/gun/1.xpm";
	data->gun[1] = "./textures/gun/2.xpm";
	data->gun[2] = "./textures/gun/3.xpm";
	data->gun[3] = "./textures/gun/4.xpm";
}
...
void put_gun(t_data *data)
{
	...
	if (data->shoot == 0)
		mlx_put_image_to_window(data->mlx, data->win,
			img, (SCREEN_WIDTH / 2) - 90 , SCREEN_HEIGHT - 128);
